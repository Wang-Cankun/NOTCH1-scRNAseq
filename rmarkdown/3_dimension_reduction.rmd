...
```{r,echo=F,eval=T,message=F,warning=F,error=F}
# Clusters won't be used for downstream analysis, as batch removal is actually not needed
...
combined <- RunUMAP(combined, reduction = "pca", dims = 1:20, n.components = 3L, n.neighbors = 50, min.dist = 0.6)
